...
[TestFixture]
public sealed class ApproveCommentCommandHandlerTests
{
    private Mock<IApplicationDbContext> _contextMock = null!;
    private Mock<IUser> _userMock = null!;
    private ApproveCommentCommandHandler _handler = null!;
    ...
    public void SetUp()
    {
        ...
        _handler = new ApproveCommentCommandHandler(_contextMock.Object, _userMock.Object);
    }
    ...
    [Test]
    public async Task Handle_WithValidMovieAndComment_ShouldApproveComment()
    {
        // Arrange
    ...
    [Test]
    public async Task Handle_WithValidApproval_ShouldSaveChanges()
    {
        // Arrange
        var movie = Movie.Create("Test Movie", null, null, null, null, null, null);
        movie.AddComment("user-123", "Great movie!");
    ...
    public async Task Handle_ShouldSetReviewerIdFromCurrentUser()
    {
        // Arrange
        var movie = Movie.Create("Test Movie", null, null, null, null, null, null);
        var comment = movie.AddComment("user-123", "Great movie!");
        _movies.Add(movie);
